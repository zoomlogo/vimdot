...
se stal=2 list bg=dark gfn=sevka,agave_NF_r:h13 cole=1 pp+=~/.vim fdls=99 ai nohid
se bs=2 sc wmnu shm=asWIcq ttimeout ttm=100 top rtp+=~/k/vim-k enc=utf-8 scl=number ut=100
...
sy enable
colo decino
let &listchars = "tab:\xbb ,space:\xb7"
