"basic config
se nocp nohls nowrap et ts=4 sw=4 nobk ru is nonu nornu ls=2 tgc noswf nowb so=1 t_Co=256
se stal=2 list bg=dark gfn=sevka,agave_NF_r:h13 cole=1 pp+=~/.vim fdls=99 ai nohid cpt+=o
