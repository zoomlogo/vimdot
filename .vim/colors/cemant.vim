...
exec "hi SpecialKey   term=bold     ctermfg=0 guifg=" . s:dark
exec "hi NonText   term=bold     ctermfg=0 guifg=" . s:dark
...
exec "hi Comment cterm=italic ctermfg=12 term=italic gui=italic guifg=" . s:Blue
